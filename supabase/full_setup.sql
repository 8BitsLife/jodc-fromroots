-- ==============================================================================
-- JODC — Complete Repo of the Week Supabase Setup (Schema + Seed)
-- ==============================================================================
-- Instructions:
-- 1. Open your Supabase project: https://supabase.com/dashboard/project/jaojqwvuvqxrhiwkgdrg/sql
-- 2. Click "+ New query"
-- 3. Paste this ENTIRE file into the editor and click "RUN" (green button)
...
CREATE POLICY "Service role has full access to repos"
    ON public.repos FOR ALL TO service_role
...
CREATE POLICY "Service role has full access to spotlights"
    ON public.spotlights FOR ALL TO service_role
    USING (true) WITH CHECK (true);
...
-- ------------------------------------------------------------------------------
-- 5. Seed Initial Repositories & Spotlights
-- ------------------------------------------------------------------------------
